 ...
 *
 * Vive como pestaña dentro de Campañas desde 2026-09-08 (antes era la página propia
 * `/dashboard/campaign-rewards`, hoy una redirección). Ref: docs/features/reward-grants.md
 */
export function CampaignRewardsCatalog() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Los premios que las campañas <span className="font-medium text-foreground">regalan</span>,
        distintos de los premios por puntos, que el cliente se gana.
      </p>
