...
| Grafo | Al día sobre `918dadd` (2026-09-07): 4.640 nodos, 7.981 aristas, 416 comunidades. ⚠️ **No incluye `feat/visual`**: `graphify-out/` vive en el checkout principal, que está en `feat/conexiones`, así que correrlo ahí indexaría la rama de otra sesión. Se corre `graphify update .` cuando esta rama entre a `main` |
