...
0.PLANTILLAS **Rediseño del sistema de plantillas: el dueño decidió el 12 (una por una desde el panel, urgente). El prompt para la sesión que lo construye está en `docs/prompts/2026-09-12-plantillas-una-por-una.md`.** Antes:
