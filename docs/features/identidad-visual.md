...
> **Migración:** `00048_identidad_visual.sql` — **escrita, SIN aplicar**
...
Sin error y sin aviso. Por eso la **00048** agrega `jsonb_deep_merge()` y
...
1. **La 00048 va ANTES del código.** Sin ella, `merge_tenant_config_deep` no existe y todo guardado
