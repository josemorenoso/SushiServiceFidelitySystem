...
/**
 * Gestor de plantillas para tenants TWILIO.
 *
 * Es la pantalla de Plantillas tal como existía antes del §12, movida aquí SIN
 * un solo cambio de comportamiento. Decisión textual del dueño sobre los 4
 * tenants que ya operan en Twilio (Sushi Service, Don Alirio, Frangal, Demo):
 * "déjalos así, ni los toques".
 *
 * El catálogo estándar de 13 plantillas con estilos vive en
 * `TemplateCatalogEditor.tsx` y aplica solo a tenants Zernio. `page.tsx` elige
 * cuál mostrar según el proveedor del negocio.
 */
...
import StandardCatalogGaps from '@/components/dashboard/templates/StandardCatalogGaps'
import {
  FileText,
  Plus,
  Eye,
...
export default function TwilioTemplateManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Lo que FALTA del set estándar, antes de la lista de lo que hay: si una
          campaña no aparece en el dashboard, la causa está acá arriba. */}
      <StandardCatalogGaps onCreated={fetchTemplates} />
