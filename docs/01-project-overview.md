...
|------|-------------|--------|
| 1 | Setup + Auth + Estructura base | [x] En progreso |
| 2 | QR Check-in (Registro presencial) | [ ] Pendiente |
| 3 | Webhook Domicilios (WhatsApp) | [ ] Pendiente |
| 4 | Campañas y Automatizaciones (Cron) | [ ] Pendiente |
| 5 | Dashboard Administrativo | [ ] Pendiente |
