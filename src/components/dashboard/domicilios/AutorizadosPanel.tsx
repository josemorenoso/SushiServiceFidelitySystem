...
/**
 * Pestaña «Autorizados» de /dashboard/domicilios: los celulares que pueden mandar un pedido
 * por WhatsApp y a qué sede se atribuye lo que entra por cada uno.
 *
 * Hasta el 2026-09-12 era una página aparte (`/dashboard/authorized-numbers`, entrada propia
 * en el menú). El dueño la pidió DENTRO de Domicilios: es la misma cosa vista desde el otro
 * lado —quién manda los pedidos que la otra pestaña lista—. La ruta vieja redirige acá.
 * Los endpoints `/api/dashboard/authorized-numbers` no cambian.
 */
...
export function AutorizadosPanel() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="flex items-center gap-2 text-lg font-semibold" style={{ color: 'var(--brand-ink)' }}>
            <ShieldCheck className="h-5 w-5" strokeWidth={1.5} />
            Números autorizados (meseros)
          </h2>
          <p className="text-sm" style={{ color: 'var(--brand-ink-soft)' }}>
            Los celulares que pueden mandar un pedido por WhatsApp, y a qué sede se atribuye.
          </p>
        </div>
