...
| `aios_attach_zernio_account(slug, profile, account, phone)` (00067, 2026-09-12) | Bloque «4-bis» de una sede en **Twilio** en el AIOS | Escribe los tres `zernio_*` y **nunca** `messaging_provider`. Es la excepción del Golden Bullet por la línea de coexistencia (`docs/features/golden-bullet.md` § "Por qué línea sale la difusión"). Se niega con `ya_es_zernio` si la marca ya manda por Zernio. |
