...
> Bucket público para el **logo de la marca** (§6, migración 00048).
...
> (escáner de meseros, §19). Es la deuda **D4/D5** ya registrada en `ESTADO.md`, anterior a la 00048.
